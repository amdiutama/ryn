...
def pilih_masuk():
	msuk = raw_input("\033[1;97m Wong tuamu Lungo, Wes sepi... ")
	if msuk =="":
...
def menu():
	...
	print logo
	print "\033[1;97m _______________________________________"
	print "\033[1;97m RAIMU WASUUU:::: \033[1;97m "+nama
...
######PILIH######
def pilih():
	unikers = raw_input("\033[1;97m Siap Croooottt")
	if unikers =="":
		print "\033[1;97m _______________________________________"
		pilih()
...
#### PILIH INDONESIA ####
def pilih_indo():
	teak = raw_input("\033[1;97m Wayahe Ngecroot... ")
	print "\033[1;97m _______________________________________"
	if teak =="":
		print"\033[1;97m Isi Sing Bener Cok !"
		pilih_indo()
